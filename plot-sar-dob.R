...
1.# to assin a code to each soil core based on their locations within the 40 by 40 plots
...
for (i in 1:908)
  ...
  else if(str_detect(sub_sample,"5"))
  {
    assign_ID[i]=5
  }
...
richness_dob=cbind(dob_plot,richness_dob)%>%data.frame()%>%melt()
3.# 
