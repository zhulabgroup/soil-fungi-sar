...
aa=ggboxplot(comp_vege, x = "type", y = "z", fill = "type", outlier.shape = NA) +
  ...
  annotate("text", x = 1, y = 1.03, label = "e", size = 6) +
  annotate("text", x = 2, y = 1.05, label = "e", size = 6) +
  annotate("text", x = 3, y = 1.07, label = "e", size = 6) +
  annotate("text", x = 4, y = 1.15, label = "d", size = 6) +
  annotate("text", x = 5, y = 1.13, label = "ce", size = 6) +
  annotate("text", x = 6, y = 1.125, label = "bcd", size = 6) +
  annotate("text", x = 7, y = 1.218, label = "b", size = 6) +
  annotate("text", x = 8, y = 1.1108, label = "ace", size = 6)
