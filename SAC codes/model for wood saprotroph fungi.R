...
woosap_model <- cbind(woosap_model, c = 2.71828^woosap_model$logc)# need to transfer the logc to c
# when root traits were considered
...
3. # build a model for the woosap guild,with 104 plots included, rich and d13
# root traits were included
