...
p_land_245=ggplotGrob(ggplot(species_change_land_rcp245_all) +
                        ...
                        scale_color_gradient2(expression("Change %"), high = "#40B0A6", mid="white",low = "#E1BE6A", na.value = "white")+
...
p_land_latitude_245=ggplotGrob(ggplot()+
                                 geom_line(data = summary_data, aes(x = lat, y = 100*mean_value), color = "black", size = 0.5) +  # Mean trend line
                                 geom_ribbon(data = summary_data, aes(x = lat, ymin = 100*mean_value - 100*sd_value, ymax = 100*mean_value +100*sd_value), fill = "black", alpha = 0.2)+
...
p_climate_latitude_245=ggplotGrob(ggplot()+
                                    geom_line(data = summary_data_climate_rcp245, aes(x = lat, y = 100*mean_value), color = "black", size = 0.5) +  # Mean trend line
                                    geom_ribbon(data = summary_data_climate_rcp245, aes(x = lat, ymin = 100*mean_value - 100*sd_value, ymax = 100*mean_value + 100*sd_value), fill = "black", alpha = 0.2)+
                                    theme(
                                      legend.text = element_text(size=8),
...
p_land_latitude_585=ggplotGrob(ggplot()+
                                 geom_line(data = summary_data_land_rcp585, aes(x = lat, y = 100*mean_value), color = "black", size = 0.5) +  # Mean trend line
                                 geom_ribbon(data = summary_data_land_rcp585, aes(x = lat, ymin = 100*mean_value - 100*sd_value, ymax = 100*mean_value + 100*sd_value), fill = "black", alpha = 0.2)+
                                 theme(
                                   legend.text = element_text(size=8),
                                   legend.title  = element_text(size=10),
                                   text = element_text(size = 18),
...
p_climate_latitude_585=ggplotGrob(ggplot()+
                                    geom_line(data = summary_data_climate_rcp585, aes(x = lat, y = 100*mean_value), color = "black", size = 0.5) +  # Mean trend line
                                    geom_ribbon(data = summary_data_climate_rcp585, aes(x = lat, ymin = 100*mean_value - 100*sd_value, ymax = 100*mean_value + 100*sd_value), fill = "black", alpha = 0.2)+
                                    theme(
                                      legend.text = element_text(size=8),
                                      legend.title  = element_text(size=10),
                                      text = element_text(size = 18),
