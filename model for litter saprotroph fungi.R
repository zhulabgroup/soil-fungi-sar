...
litsap_model <- subset(litsap_model, siteIDD != "GUAN" & z < 10 & fine > 0 & rootc > 0 & rich > 0) # only 104 plots from 33 sites



# standardized data
litsap_model[, c(2, 5:27)] <- apply(litsap_model[, c(2, 5:27)], 2, range01)
# colinearity
